---
name: update-doc
description: Scan the codebase and update README.md and AGENTS.md to reflect the current implementation.
disable-model-invocation: true
---

# Update Documentation

Scan the entire codebase and update `README.md` and `AGENTS.md` to accurately reflect the current state of the project.

## Workflow

### Step 0: Check What Changed (optional shortcut)

Run `git log --oneline --all -- AGENTS.md README.md` to find the last doc-touching commit. Then run `git diff <that-commit>..HEAD --name-only` to get a list of files changed since then.
...
Read `README.md` and `AGENTS.md` in full. Note their current structure and content.
...
Re-read both `README.md` and `AGENTS.md` after editing. Confirm:
...
- **Keep AGENTS.md developer-focused** — Full technical reference
